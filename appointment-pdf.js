...
doc.text(
"GAU MATA RASHTRAMATA SAMMAN ABHIYAN",
105,
63,
{align:"center"}
);
...
const paragraph =
"Dear ${data.name || "Member"}, You are hereby appointed as ${data.designation || "Volunteer"} in Unnati Swayam Sahayata Samiti under the Gau Mata Rashtramata Samman Abhiyan. Your contribution towards social service, cow protection, awareness campaigns and organisational activities is highly appreciated.";
