...
doc.text("नाम : ${data.name || ""}", 20, y);
y += 10;

doc.text("पिता/पति : ${data.father_name || ""}", 20, y);
y += 10;

doc.text("मोबाइल : ${data.mobile || ""}", 20, y);
y += 10;

doc.text("ईमेल : ${data.email || ""}", 20, y);
y += 10;

doc.text("पता : ${data.address || ""}", 20, y);
y += 10;
...
doc.text(
"Volunteer ID : ${ data.volunteer_id || data.volunteerId || "-" }",
20,
y
);
